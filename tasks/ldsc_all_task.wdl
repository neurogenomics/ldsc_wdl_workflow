...
task partritioned_ld_score_loop {
    String? output_file_address
    String? work_directory
    String? out_file_name

    String? bfile_address
    String? bfile_preflix
    String? annot_address
    String? annot_preflix
    String? annot_sufflix
    String? snp_address
    String? preflix_snp
    String? sufflix_snp
    ...
    do
        ...
        ./ldsc.py \
        ${l2_argument} \
        --bfile ${bfile_address}/${bfile_preflix}."$j" \
        --annot ${annot_address}/${annot_preflix}.$i.$j.${annot_sufflix} \
        ${ld_wind_argument} \
        ${thin_annot_argument} \
        --out ${out_file_name}.$i.$j \
        --print-snps ${snp_address}/${preflix_snp}."$j".${sufflix_snp}

        mv ${out_file_name}.$i.$j.log ${out_file_name}.$i.$j.l2.M_5_50 ${out_file_name}.$i.$j.l2.M ${out_file_name}.$i.$j.l2.ldscore.gz -t ${output_file_address}
        done
    done
...
workflow test_partritioned_ld_score_loop {
    String workflow_output_file_address
    String workflow_working_directory
    String name_of_output
    String number_of_celltypes

    call partritioned_ld_score_loop {
        ...
        cell_types_number = number_of_celltypes
    }
